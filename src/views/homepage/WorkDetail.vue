<template>
    <div class="work-detail" :style="{ maxHeight: isSafari ? 'calc(100% - 100px)' : '' }">
        <div :style="{ height: coverH + 'px' }" v-if="workData.contestGroup != 3" @click="zoomOn = true" class="cover-box">
            <img class="img" @load="imgLoad" :src="workData.workFile" alt="">
        </div>
